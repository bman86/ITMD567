...
public class DateTime {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("_1Open", _1Open).append("_2High", _2High).append("_3Low", _3Low).append("_4Close", _4Close).append("_5Volume", _5Volume).append("additionalProperties", additionalProperties).toString();
    }

    public DateTime(){}

    public DateTime(String _1Open, String _2High, String _3Low, String _4Close, String _5Volume, Map<String, Object> additionalProperties) {
        this._1Open = _1Open;
        this._2High = _2High;
        this._3Low = _3Low;
        this._4Close = _4Close;
